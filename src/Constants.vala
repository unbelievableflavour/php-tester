namespace RepositoriesManager.Constants {
    ...
    public const string DESKTOP_NAME = "com.github.bartzaalberg.php-tester.desktop";
    public const string APPLICATION_ID = "com.github.bartzaalberg.php-tester.desktop";
